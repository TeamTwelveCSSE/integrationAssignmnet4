<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accepted Requisitions.aspx.cs" Inherits="Team12.Accepted_Requisitions" %>
...
<head runat="server">
    ...
    <title>Accepted Requisitions</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="container">
                    <div class="row">
                         <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="Accepted Requisitions.aspx" runat="server">Accepted Requisitions</a></li>
                        ...
                        <div class="tab-content">
                            <div id="Approve" class="tab-pane fade in active">
                                <h3>Accepted Requisitions</h3>
                                    ...
                                    <br />
                                    <asp:GridView ID="GridView1" runat="server" CellPadding="8" CellSpacing="2" ForeColor="#333333" Width="1200px"  GridLines="None" SelectedRowStyle-Height="10px" HorizontalAlign="Center" AutoGenerateSelectButton="True">
                                        ...
                                        <HeaderStyle BackColor="#5cb85c" Font-Bold="True" ForeColor="White" HorizontalAlign="Center"  VerticalAlign="Middle" Height="40px" />
