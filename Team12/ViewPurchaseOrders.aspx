<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewPurchaseOrders.aspx.cs" Inherits="Team12.ViewPurchaseOrders" %>
                    ...
                    <div class="row">
                         <ul class="nav nav-tabs">
                            ...
                            <li><a href="DenyRequisitions.aspx" runat="server">Deny Requisitions</a></li>
                             ...
                             <%--<li><a href="AcceptOrDeny.aspx" runat="server">Accept Or Deny Requisitions </a></li>--%>
                        </ul>
                    </div>
                    <div>
