<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveRequisitions.aspx.cs" Inherits="Team12.ApproveRequisitions" %>
                ...
                <div class="container">
                    <div class="row">
                         <ul class="nav nav-tabs">
                            <li class="active"><a href="ApproveRequisitions.aspx" runat="server">Approve Requisitions</a></li>
                            ...
                            <div id="Approve" class="tab-pane fade in active">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row top-buffer">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-4">Assigned Employee</div>
                                            <div class="col-md-8"><asp:DropDownList ID = "DropDownList1" runat="server" class="form-control"></asp:DropDownList></div>
                                        </div>
                                        <div class="col-md-2" >
                                            <div>
                                                <asp:Button ID="btnSearch" runat="server"  class="btn btn-success"  Text="  Find  " OnClick="btnSearch_Click"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" onselectedindexchanged="GridView1_SelectedIndexChanged" CellPadding="8" CellSpacing="2" ForeColor="#333333" Width="1200px"  GridLines="None" SelectedRowStyle-Height="10px" HorizontalAlign="Center" AutoGenerateSelectButton="True">
