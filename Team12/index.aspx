<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Team12.index" %>
...
<body>
    ...
    <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            <li data-target='#carousel-example-generic' data-slide-to='0' class='active'>
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Resources/images/12.jpg"
                    Width="100px" Height="50px" /></li>
            <li data-target='#carousel-example-generic' data-slide-to='1'>
                <asp:Image ID="Image2" runat="server" ImageUrl="~/Resources/images/13.jpg" Width="100px" Height="50px" /></li>
            <li data-target='#carousel-example-generic' data-slide-to='2'>
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Resources/images/14.jpg" Width="100px" Height="50px" /></li>
        </ol>
        <!-- Wrapper for slides -->
    ...
    <section id="services" class="padding50">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <i class="fa fa-building-o animated wow fadeInDown"></i>
                    <div class="sc-inner">
                        <h4>
                            Order</h4>
                        <p>
                ...
                <!-- ./ end service box -->
                <div class="col-md-4">
                    <i class="fa fa-user animated wow fadeInDown" data-wow-delay="0.2s"></i>
                    <div class="sc-inner">
                        <h4>
                            Supplier</h4>
                        <p>
                ...
                <!-- ./ end service box -->
                <div class="col-md-4">
                    <i class="fa fa-money animated wow fadeInDown" data-wow-delay="0.4s"></i>
                    <div class="sc-inner">
                        <h4>
                            Payment</h4>
                        <p>
    ...
    <div class="padding100" id="blog">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7">
                    <a href="#">
                        <img class="img-responsive animated wow fadeInLeft" data-wow-delay="0.2s" src="Resources/images/700x300.jpg"
                            alt="">                       
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 animated wow fadeInUp" data-wow-delay="0.6s">
                    <div id="screens" class="owl-carousel">
                        <div>
                            <img src="Resources/images/products/1.jpg" class="img-responsive" alt="screens">
                        </div>
                        <div>
                            <img src="Resources/images/products/2.jpg" class="img-responsive" alt="screens">
                        </div>
                        <div>
                            <img src="Resources/images/products/3.jpg" class="img-responsive" alt="screens">
                        </div>
                        <div>
                            <img src="Resources/images/products/1.jpg" class="img-responsive" alt="screens">
                        </div>
