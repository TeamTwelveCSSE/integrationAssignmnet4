<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcceptOrDeny.aspx.cs" Inherits="Team12.AcceptOrDeny" %>
...
<head runat="server">
    ...
    <title>Accept Or Deny Requisitions</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="row">
                         <ul class="nav nav-tabs">
                           <li><a href="ApproveRequisitions.aspx" runat="server">Approve Requisitions</a></li>
                            <li class="active"><a href="PendingRequisitions.aspx" runat="server">Pending Requisitions</a></li>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row top-buffer">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-8"><asp:TextBox ID="txtPriority" runat="server" class="form-control" ></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        </div>
                                    ...
                                    <div class="row top-buffer">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-8"><asp:TextBox ID="txtStatus" runat="server" class="form-control" ></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        </div>
                                    ...
                                    <div class="row top-buffer">
                                        ...
                                        <div class="col-md-6">
                                            <asp:Button ID="Button1" runat="server" Text=" Accept " class=" btn btn-info" OnClick="Button1_Click" />
                                                <asp:Button ID="Button2" runat="server" Text=" Deny " class="btn btn-danger" OnClick="Button2_Click" />
                                        </div>
                                        <div class="col-md-3">
                                        </div>
                                    </div>
